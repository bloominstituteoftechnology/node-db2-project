...
| ------------ | ---------------- | --------------------------------------------------- |
[x]| id           | unsigned integer | primary key, auto-increments, generated by database |
[x]| vin          | string           | required, unique                                    |
[x]| make         | string           | required                                            |
[x]| model        | string           | required                                            |
[x]| mileage      | numeric          | required                                            |
[x]| title        | string           | optional                                            |
[x]| transmission | string           | optional                                            |
